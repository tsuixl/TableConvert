...
beforTime = os.clock()
require("_MoeLua.Config.army.MoeArmySettingNoTest")
print(string.format( "Load [MoeArmySettingNoTest] %f s count %d", os.clock() - beforTime, ConfigMgr:GetDataCount(ConfigType.ArmySettingNoTest)))
